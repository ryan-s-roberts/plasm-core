-- Precomputed embeddings for typed discovery (`plasm-discovery` / fastembed), keyed by pinned CGS digest.
-- Stored as BYTEA (little-endian f32[]); no pgvector extension required.
